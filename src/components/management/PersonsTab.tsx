...
const defaultSquadFrom = `${new Date().getFullYear()}-01-01`;
    ...
    mutationFn: (f: FormState) =>
      api
        .post("/management/persons", {
          ...
          effective_from: f.squad_id ? f.squad_from : undefined,
        })
        .then((r) => r.data),
    onSuccess: () => {
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <Select
              ...
              onValueChange={(v) =>
                setForm({ ...form, squad_id: v === "none" ? "" : v, squad_from: defaultSquadFrom })
              }
            >
              <SelectTrigger>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1.5 min-w-0">
                <Label className="flex items-center gap-1">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent>
                      Allocation % is the percentage of the person&apos;s weekly hours.
                    </TooltipContent>
                  </Tooltip>
                </Label>
                <Input
              ...
              {modalMode === "create" && (
                <div className="space-y-1.5 min-w-0">
                  ...
                  <DatePicker
                    required
                    value={form.squad_from}
                    onChange={(v) => setForm({ ...form, squad_from: v })}
                  />
                </div>
              )}
            </div>
